using DailyTools.Domain.Events;
using Microsoft.Extensions.Logging;

namespace DailyTools.Application.TodoItems.EventHandlers;
...
public class LogTodoItemCompleted : INotificationHandler<TodoItemCompletedEvent>
{
    ...
    {
        _logger.LogInformation("DailyTools Domain Event: {DomainEvent}", notification.GetType().Name);
